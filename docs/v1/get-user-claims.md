...
https://retroachievements.org/API/API\_GetUserClaims.php?u=Jamiras
...
| Repo       | URL                                                                                                                  |
| :--------- | :------------------------------------------------------------------------------------------------------------------- |
| RAWeb      | https://github.com/RetroAchievements/RAWeb/blob/master/public/API/API\_GetUserClaims.php                              |
