...
https://retroachievements.org/API/API\_GetUserCompletionProgress.php?u=MaxMilyin
...
| Repo       | URL                                                                                                                  |
| :--------- | :------------------------------------------------------------------------------------------------------------------- |
| RAWeb      | https://github.com/RetroAchievements/RAWeb/blob/master/public/API/API\_GetUserCompletionProgress.php                  |
