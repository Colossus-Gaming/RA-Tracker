...
https://retroachievements.org/API/API\_GetUserGameLeaderboards.php?i=1\&u=zuliman92
...
| Repo   | URL                                                                                               |
| :----- | :------------------------------------------------------------------------------------------------ |
| RAWeb  | https://github.com/RetroAchievements/RAWeb/blob/master/public/API/API\_GetUserGameLeaderboards.php |
