...
https://retroachievements.org/API/API\_GetUserRecentAchievements.php?u=Scott
...
| Repo       | URL                                                                                                                  |
| :--------- | :------------------------------------------------------------------------------------------------------------------- |
| RAWeb      | https://github.com/RetroAchievements/RAWeb/blob/master/public/API/API\_GetUserRecentAchievements.php                  |
