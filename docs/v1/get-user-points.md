...
https://retroachievements.org/API/API\_GetUserPoints.php?u=Hexadigital
...
| Repo       | URL                                                                                                                  |
| :--------- | :------------------------------------------------------------------------------------------------------------------- |
| RAWeb      | https://github.com/RetroAchievements/RAWeb/blob/master/public/API/API\_GetUserPoints.php                              |
