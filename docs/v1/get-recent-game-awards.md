...
https://retroachievements.org/API/API\_GetRecentGameAwards.php
...
| Repo       | URL                                                                                                                  |
| :--------- | :------------------------------------------------------------------------------------------------------------------- |
| RAWeb      | https://github.com/RetroAchievements/RAWeb/blob/master/public/API/API\_GetRecentGameAwards.php                        |
