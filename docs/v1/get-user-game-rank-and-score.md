...
https://retroachievements.org/API/API\_GetUserGameRankAndScore.php?g=14402\&u=WCopeland
...
| Repo       | URL                                                                                                                  |
| :--------- | :------------------------------------------------------------------------------------------------------------------- |
| RAWeb      | https://github.com/RetroAchievements/RAWeb/blob/master/public/API/API\_GetUserGameRankAndScore.php                    |
