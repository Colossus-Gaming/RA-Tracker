...
https://retroachievements.org/API/API\_GetUserWantToPlayList.php?u=MaxMilyin
...
| Repo       | URL                                                                                                                  |
| :--------- | :------------------------------------------------------------------------------------------------------------------- |
| RAWeb      | https://github.com/RetroAchievements/RAWeb/blob/master/public/API/API\_GetUserWantToPlayList.php                      |
