...
https://retroachievements.org/API/API\_GetAchievementUnlocks.php?a=9
...
| Repo       | URL                                                                                                                  |
| :--------- | :------------------------------------------------------------------------------------------------------------------- |
| RAWeb      | https://github.com/RetroAchievements/RAWeb/blob/master/public/API/API\_GetAchievementUnlocks.php                      |
