...
https://retroachievements.org/API/API\_GetAchievementsEarnedOnDay.php?u=MaxMilyin\&d=2022-10-14
...
| Repo       | URL                                                                                                                  |
| :--------- | :------------------------------------------------------------------------------------------------------------------- |
| RAWeb      | https://github.com/RetroAchievements/RAWeb/blob/master/public/API/API\_GetAchievementsEarnedOnDay.php                 |
