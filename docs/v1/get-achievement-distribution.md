...
https://retroachievements.org/API/API\_GetAchievementDistribution.php?i=14402\&h=1
...
| Repo       | URL                                                                                                                  |
| :--------- | :------------------------------------------------------------------------------------------------------------------- |
| RAWeb      | https://github.com/RetroAchievements/RAWeb/blob/master/public/API/API\_GetAchievementDistribution.php                 |
