...
https://retroachievements.org/API/API\_GetUserProgress.php?u=MaxMilyin\&i=1,2,3
...
| Repo       | URL                                                                                                                  |
| :--------- | :------------------------------------------------------------------------------------------------------------------- |
| RAWeb      | https://github.com/RetroAchievements/RAWeb/blob/master/public/API/API\_GetUserProgress.php                            |
